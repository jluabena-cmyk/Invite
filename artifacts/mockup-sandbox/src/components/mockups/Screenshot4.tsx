export default function Screenshot4() {
  const items = [
    ...
    { name: "Sake (2 bottles)", price: 48, assignee: "Split evenly", color: null, initials: null, split: true },
    { name: "Edamame", price: 8, assignee: "Split evenly", color: null, initials: null, split: true },
    { name: "Salmon Sashimi", price: 24, assignee: "Alex T.", color: "#10B981", initials: "AT" },
    { name: "Miso Soup ×3", price: 15, assignee: "Split evenly", color: null, initials: null, split: true },
  ];
  return (
    <div style={{ width: 390, height: 844, background: "#FAF5EF", fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "10px 20px 8px", display: "flex", alignItems: "center", gap: 12 }}>
        <div style={{ width: 44, height: 44, borderRadius: 12, background: "#FFF7ED", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24 }}>🍣</div>
        <div>
      ...
      <div style={{ padding: "0 20px", display: "flex", gap: 0, marginBottom: 12 }}>
      ...
      <div style={{ flex: 1, padding: "0 20px", display: "flex", flexDirection: "column", gap: 8, overflowY: "hidden" }}>
        {items.map((item, i) => (
          <div key={i} style={{ background: "#fff", borderRadius: 12, padding: "11px 14px", border: "1px solid #F0EAE2", display: "flex", alignItems: "center", gap: 10 }}>
            {item.split ? (
              <div style={{ width: 30, height: 30, borderRadius: 15, background: "#F5F0EB", border: "2px dashed #C2410C", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <span style={{ fontSize: 13 }}>÷</span>
              </div>
            ) : (
              <div style={{ width: 30, height: 30, borderRadius: 15, background: item.color!, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 12, color: "#78716C", marginTop: 2 }}>{item.assignee}</div>
            </div>
      ...
      <div style={{ padding: "10px 20px 16px", borderTop: "1px solid #F0EAE2" }}>
        <div style={{ background: "rgba(194,65,12,0.06)", borderRadius: 16, padding: "14px 18px", border: "1px solid rgba(194,65,12,0.15)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
            ...
            <span style={{ fontSize: 13, color: "#78716C" }}>$135</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
            <span style={{ fontSize: 13, color: "#78716C" }}>Tip (20%)</span>
            <span style={{ fontSize: 13, color: "#78716C" }}>$27</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <span style={{ fontSize: 17, fontWeight: 700, color: "#1C1917" }}>Your share</span>
            <span style={{ fontSize: 20, fontWeight: 800, color: "#C2410C" }}>$32.50</span>
          </div>
        </div>
      </div>
